...
for(let i = 0; i < graduates.length; i++){
  if(graduates[i].university.includes("uni")){
    uni.push(graudates[i].university);
  }
}
console.log(uni);
...
const populationTotal = zooAnimals.reduce(function(animalsTotal, i){
  return animalsTotal + i.population;
});
